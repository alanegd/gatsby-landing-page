        ...
        <div class="container mx-auto flex flex-wrap justify-between text-white">
          ...
          <div class="flex justify-center gap-10 px-5">
            ...
            <div>
              ...
              <ul class="text-gray-400">
                <li class="mb-4">
                  <a href="#" class="hover:underline cursor-pointer">Privacy Policy</a>
                </li>
                <li>
                  <a href="#" class="hover:underline cursor-pointer">Terms & Conditions</a>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul class="text-gray-400">
                  <li class="mb-4">
                    <a href="#" class="hover:underline cursor-pointer">Contact us</a>
                  </li>
                  <li>
                    <a href="#" class="hover:underline cursor-pointer">FAQ</a>
                  </li>
                </ul>
              </div>
            </div>
